...
SELECT created_feed_follow.id, created_feed_follow.created_at, created_feed_follow.updated_at, created_feed_follow.user_id, created_feed_follow.feed_id, feeds.name AS feed_name, users.name AS user_name
